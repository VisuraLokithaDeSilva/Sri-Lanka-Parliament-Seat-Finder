...
const members = [
    ...
    { name: "Hon. Aboobucker Athambawa", seat: "G-86 (National List)" },
    { name: "Hon. (Dr.) Najith Indika", seat: "G-102 (National List)" },
    { name: "Hon. (Ms.) Lakmali Hemachandra (AAL)", seat: "G-116 (National List)" },
