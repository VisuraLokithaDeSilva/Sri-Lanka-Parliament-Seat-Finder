...
const members = [
    ...
    { name: "Hon. Ajith Agalakada", seat: "G-60 Moneragala)" },
    ...
    { name: "Hon. (Mrs.) Sagarika Athauda (AAL)", seat: "G-65 (Kegalla)" },
    { name: "Hon. Roshan Akmeemana", seat: "G-66 (Trincomalee)" },
    { name: "Hon. U.P. Abeywickrama (AAL)", seat: "G-67 (Gampaha)" },
    { name: "Hon. (Prof.) L.M. Abeywickrama", seat: "G-68 (Matara)" },
    { name: "Hon. M.K.M. Aslam", seat: "G-69 (Kurunegala)" },
    { name: "Hon. (Dr.)(Ms.) Kaushalya Ariyarathne", seat: "G-70 (Colombo)" },
    { name: "Hon. Asitha Niroshana Egoda Vithana", seat: "G-71 (Colombo)" },
    { name: "Hon. Arkam Ilyas", seat: "G-72 (Matara)" },
    { name: "Hon. (Mrs.) Oshani Umanga", seat: "G-73 (Kalutara)" },
    { name: "Hon. (Ms.) Krishnan Kalaichelvi", seat: "G-74 (Nuwara Eliya)" },
    { name: "Hon. Upul Kithsiri", seat: "G-75 (Ratnapura)" },
    { name: "Hon. Wasantha Pushpa Kumara", seat: "G-76 (Ratnapura)" },
    { name: "Hon. Chaminda Lalith Kumara", seat: "G-77 (Gampaha)" },
    { name: "Hon. Sarath Kumara (AAL)", seat: "G-78 (Moneragala)" },
    { name: "Hon. (Mrs.) Nilanthi Kottahachchi (AAL)", seat: "G-79 (Kalutara)" },
    { name: "Hon. (Mrs.) M.A.C.S. Chathuri Gangani", seat: "G-80 (Moneragala)" },
    { name: "Hon. Lasith Bhashana Gamage", seat: "G-81 (Gampaha)" },
    { name: "Hon. Thilanka U. Gamage", seat: "G-82 (Galle)" },
    { name: "Hon. (Mrs.) Nilusha Lakmali Gamage", seat: "G-83 (Ratnapura)" },
    { name: "Hon. Ajantha Gammeddage", seat: "G-84 (Matara)" },
    { name: "Hon. Ajith Gihan", seat: "G-85 (Puttalam)" },
    { name: "Hon. (Dr.)Jagath Gunawardana", seat: "G-86 (Kurunegala)" },
    { name: "Hon. Aboobucker Athambawa", seat: "G-87 (National List)" },
    { name: "Hon. Ruwanthilaka Jayakody", seat: "G-88 (Gampaha)" },
    { name: "Hon. (Mrs.) Thushari Jayasingha (AAL)", seat: "G-89 (Kandy)" },
    ...
    { name: "Hon. (Mrs.) Anushka Thilakarathne (AAL)", seat: "G-94 (Nuwara Eliya)" },
    ...
    { name: "Hon. Susantha Dodawatta (AAL)", seat: "G-100 Colombo)" },
    { name: "Hon. Susantha Kumara Nawarathna", seat: "G-101 (Anuradhapura)" },
    { name: "Hon. (Prof.) Sena Nanayakkara", seat: "G-102 (Anuradhapura)" },
