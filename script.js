...
const members = [
    { name: "HON. K.V. Samantha Viddyarathna", seat: "G-01 (Badulla)" },
    ...
    { name: "Hon. Kumara Jayakody", seat: "G-24 (National List)" },
    ...
    { name: "Hon. Nihal Galappaththi", seat: "G-25 (Hambantota)" },
    { name: "Hon. (Dr.) Nihal Abeysinghe", seat: "G-26 (Kalutara)" },
    { name: "Hon. Namal Karunaratne", seat: "G-27 (Kurunegala)" },
    { name: "Hon. Wasantha Piyathissa", seat: "G-28 (Digamadulla)" },
    { name: "Hon. Gamagedara Dissanayake", seat: "G-29 (Matale)" },
    { name: "Hon. R.M. Jayawardhana", seat: "G-30 (Moneragala)" },
    { name: "Hon. Sunil Watagala (AAL)", seat: "G-31 (Colombo)" },
    { name: "Hon. Rathna Gamage", seat: "G-32 (Galle)" },
    { name: "Hon. Mahinda Jayasinghe", seat: "G-33 (Gampaha)" },
    { name: "Hon. Chathuranga Abeysinghe", seat: "G-34 (Colombo)" },
    { name: "Hon. Eranga Gunasekara", seat: "G-35 (Colombo)" },
    { name: "Hon. Upali Samarasingha", seat: "G-36 (National List)" },
    { name: "Hon. T. B. Sarath", seat: "G-37 (Polonnaruwa)" },
    { name: "Hon. Nalin Hewage", seat: "G-38 (Galle)" },
    { name: "Hon. (Dr.) Prasanna Gunasena", seat: "G-39 (Kandy)" },
    { name: "Hon. Anton Jayakody", seat: "G-40 (Puttalam)" },
    { name: "Hon. (Mrs.) Hemali Weerasekara", seat: "G-41 (Gampaha)" },
    { name: "Hon. Sundaralingam Pradeep", seat: "G-42 (Ratnapura)" },
    { name: "Hon. Ruwan Ranasinghe", seat: "G-43 (National List)" },
    { name: "Hon. Muneer Mulaffer", seat: "G-44 (Gampaha)" },
    { name: "Hon. (Dr.) Susil Ranasinghe", seat: "G-20 (Anuradhapura)" },
    ...
    { name: "HON. Major General (Rtd.) Aruna Jayasekera", seat: "G-52 (National List)" },
    { name: "Hon. Sugath Thilakaratne", seat: "G-53 (National List)" },
    { name: "Hon. Asoka Sapumal Ranwala", seat: "G-59 (Gampaha)" },
    { name: "Hon. Lakshman Nipuna Arachchi", seat: "G-60 (Colombo)" },
    { name: "Hon. R.M. Gamini Rathnayake", seat: "G-65 (National List)" },
    { name: "Hon. Manjula Suraweera Arachchi", seat: "G-66 (Nuwara Eliya)" },
    { name: "Hon. K. Ilankumaran", seat: "G-67 (Jaffna)" },
    { name: "Hon. Shantha Pathma Kumara Subasingha", seat: "G-68 (Ratnapura)" },
    { name: "Hon. Ajith Agalakada", seat: "G-69 (Moneragala)" },
    { name: "Hon. Gayan Janaka", seat: "G-61 (Puttalam)" },
    { name: "Hon. (Dr.) Najith Indika", seat: "G-62 (National List)" },
    { name: "Hon. (Ms.) Lakmali Hemachandra (AAL)", seat: "G-63 (National List)" },
    { name: "Hon. (Mrs.) Samanmali Gunasingha", seat: "G-64 (Colombo)" },
    { name: "Hon. (Mrs.) Sagarika Athauda (AAL)", seat: "G-70 (Kegalla)" },
    { name: "Hon. Roshan Akmeemana", seat: "G-71 (Trincomalee)" },
    { name: "Hon. U.P. Abeywickrama (AAL)", seat: "G-72 (Gampaha)" },
    { name: "Hon. (Prof.) L.M. Abeywickrama", seat: "G-73 (Matara)" },
    { name: "Hon. M.K.M. Aslam", seat: "G-74 (Kurunegala)" },
    { name: "Hon. (Dr.)(Ms.) Kaushalya Ariyarathne", seat: "G-54 (Colombo)" },
    { name: "Hon. Asitha Niroshana Egoda Vithana", seat: "G-75 (Colombo)" },
    { name: "Hon. Arkam Ilyas", seat: "G-55 (Matara)" },
    { name: "Hon. (Mrs.) Oshani Umanga", seat: "G-76 (Kalutara)" },
    { name: "Hon. (Ms.) Krishnan Kalaichelvi", seat: "G-77 (Nuwara Eliya)" },
    { name: "Hon. Upul Kithsiri", seat: "G-78 (Ratnapura)" },
    { name: "Hon. Wasantha Pushpa Kumara", seat: "G-79 (Ratnapura)" },
    { name: "Hon. Chaminda Lalith Kumara", seat: "G-80 (Gampaha)" },
    ...
    { name: "Hon. Ajith Gihan", seat: "G-88 (Puttalam)" },
    { name: "Hon. (Dr.)Jagath Gunawardana", seat: "G-89 (Kurunegala)" },
    { name: "Hon. Aboobucker Athambawa", seat: "G-90 (National List)" },
    { name: "Hon. Ruwanthilaka Jayakody", seat: "G-91 (Gampaha)" },
    { name: "Hon. (Mrs.) Thushari Jayasingha (AAL)", seat: "G-92 (Kandy)" },
    { name: "Hon. T.K. Jayasundara", seat: "G-93 (Galle)" },
    { name: "Hon. Mayilvaganam Jegathiswaran", seat: "G-94 (Vanni)" },
    { name: "Hon. Rajeevan Jeyachandramoorthy", seat: "G-95 (Jaffna)" },
    { name: "Hon. Sellaththamby Thilaganathan", seat: "G-96 (Vanni)" },
    { name: "Hon. (Mrs.) Anushka Thilakarathne (AAL)", seat: "G-98 (Nuwara Eliya)" },
    { name: "Hon. Chandana Thennakoon", seat: "G-99 (Kurunegala)" },
    { name: "Hon. Thanura Dissanayake", seat: "G-100 (Kandy)" },
    { name: "HON. Dharmapriya Dissanayake", seat: "G-101 (Kurunegala)" },
    ...
    { name: "Hon. Ravindra Bandara", seat: "G-114 (Badulla)" },
    { name: "Hon. Sudath Balagalla", seat: "G-115 (Badulla)" },
    { name: "Hon. (Dr.) Sri Bavanandarajah", seat: "G-116 (Jaffna)" },
    { name: "Hon. Dinindu Saman", seat: "G-57 (Badulla)" },
    { name: "Hon. Aravinda Senarath", seat: "G-56 (Hambantota)" },
    { name: "Hon. Nishantha Jayaweera", seat: "G-58 (National List)"},
    
    { name: "Hon. Prageeth Madhuranga", seat: "OG-68 (Gampaha)" },
    { name: "Hon. Jagath Manuwarna", seat: "OG-69 (Kandy)" },
    { name: "Hon. Ruwan Mapalagama", seat: "OG-70 (Gampaha)" },
    { name: "Hon. (Dr.) Nandana Millagala", seat: "OG-71 (Kegalla)" },
    { name: "Hon. Riyas Farook", seat: "OG-72 (Kandy)" },
    { name: "Hon. Danushka Ranganath", seat: "OG-81 (Kalutara)" },
    { name: "Hon. Sanjeewa Ranasingha", seat: "OG-82 (Kalutara)" },
    { name: "Hon. Sunil Rathnasiri", seat: "OG-83 (Polonnaruwa)" },
    { name: "Hon. Manjula Sugath Rathnayaka", seat: "OG-84 (Digamadulla)" },
    { name: "HON. (Mrs.) Α.Μ.Μ.M. Rathwaththe", seat: "OG-85 (Digamadulla)" },
    { name: "Hon. Manoj Rajapaksha", seat: "OG-86 (Kegalla)" },
    { name: "Hon. Sunil Rajapaksha", seat: "OG-87 (Ratnapura)" },
    { name: "Hon. (Mrs.) Hasara Liyanage (AAL)", seat: "OG-88 (Galle)" },
    { name: "Hon. (Mrs.) Deepthi Wasalage", seat: "OG-89 (Matale)" },
    { name: "Hon. Kanchana Welipitiya", seat: "OG-90 (Kegalla)" },
    { name: "Hon. R.G. Wijerathna", seat: "OG-91 (Nuwara Eliya)" },
    ...
    { name: "HON. Major General (Rtd.) G.D. Sooriyabandara", seat: "OG-103 (Kurunegala)" },
    ...
    { name: "Hon. Nandana Pathmakumara", seat: "OG-113 (Kalutara)" },
    { name: "Hon. Sunil Biyanwila", seat: "OG-114 (Matale)" },
    { name: "Hon. Samantha Ranasingha", seat: "OG-115 (Kegalle)" },
    { name: "Hon. E.M. Basnayaka", seat: "OG-65 (Kandy)" },
    { name: "Hon. Wijesiri Basnayake", seat: "OG-66 (Kurunegala)" },
    { name: "Hon. (Dr.) Sandaruwan Madarasinghe", seat: "OG-67 (Hambantota)" },
    ...
    { name: "Hon. Ajith P. Perera (AAL)", seat: "O-23 (Kalutara)" },
    ...
    { name: "Hon. Thahir Marrikkar", seat: "O-64 (National List)" },
...
function selectSuggestion(index) {
    ...
    if (suggestion.type === "member") {
        ...
        showMemberModal(suggestion.display);
    } else {
        searchBox.value = "Empty Seat";
        seatNumberInput.value = suggestion.seat;
    }
...
function getMemberDetails(name) {
    const cleanName = name.replace(/hon\.|dr\.|mrs\.|prof\.|ms\.|mr\.|pc|\(rtd\.\)|\(aal\)/gi, '')
                          .replace(/[()]/g, '')
                          .trim().toLowerCase();

    return memberDetailsData.find(m => {
        const dataName = m.name.replace(/hon\.|dr\.|mrs\.|prof\.|ms\.|mr\.|pc|\(rtd\.\)|\(aal\)/gi, '')
                               .replace(/[()]/g, '')
                               .trim().toLowerCase();
        return dataName.includes(cleanName) || cleanName.includes(dataName);
    });
}

function showMemberModal(name) {
    const details = getMemberDetails(name);
    const modal = document.getElementById('memberModal');

    if (details && modal) {
        document.getElementById('modalImage').src = details.image || 'https://via.placeholder.com/120';
        document.getElementById('modalName').textContent = details.name;
        document.getElementById('modalTitle').textContent = details.title || 'Member of Parliament';
        document.getElementById('modalMobile').textContent = details.mobile || 'N/A';
        document.getElementById('modalTelSitting').textContent = details.telephoneSitting || 'N/A';
        document.getElementById('modalTelNonSitting').textContent = details.telephoneNonSitting || 'N/A';
        document.getElementById('modalAddrSitting').textContent = details.addressSitting || 'N/A';
        document.getElementById('modalAddrNonSitting').textContent = details.addressNonSitting || 'N/A';
        document.getElementById('modalEmail').textContent = details.email || 'N/A';
